...
<body>
  ...
  <section class="text" id="definitions">
    <h2>Définitions</h2>
    <p>Refuges pour la diversité, constitués par la somme des délaissés, des réser&shy;ves et des ensembles primaires.</p>
    <p style="--ls:-4">Le délaissé procède de l’abandon d’un terrain anciennement exploité. Son origine est multiple&nbsp;: agricole, industrielle, urbaine, touristique, etc. Délaissé et friche sont synonymes.</p>
  ...
  <section class="text " id="origine">
    ...
    <p class="<?= $media == "printa4" ? "break-before" : "" ?>">Ce que perçoit l’oiseau –&nbsp;que notre regard embrasse depuis un sommet&nbsp;– est un tapis tissé de formes sombres et bourrues&nbsp;: les forêts&nbsp;; et de surfaces claires bien délimitées&nbsp;: les pâtures.</p>
    ...
    <p style="--ls:-6">Si l’on cesse de regarder le paysage comme l’objet d’une industrie on découvre subitement – est-ce un oubli du cartographe, une négligence du politique&nbsp;? – une quantité d’espaces indécis, dépourvus de fonction sur lesquels il est difficile de porter un nom. Cet ensemble n’appartient ni au territoire de l’ombre ni à celui de la lumière. Il se situe aux marges. En lisière des bois, le long des routes et des rivières, dans les recoins oubliés de la culture, là où les machines ne passent pas. Il couvre des surfaces de dimensions modestes, dispersées comme les angles perdus d’un champ&nbsp;; unitaires et vastes comme les tourbières, les landes et certaines friches issues d’une déprise récente.</p>
    <p class="">Entre ces fragments de paysage aucune similitude de forme. Un seul point commun&nbsp;: tous constituent un territoire de refuge à la diversité. Partout ailleurs celle-ci est chassée.</p>
  ...
  <section class="text" id="caractere">
    ...
    <p style="--ls:-6" ><span class="enum">9 </span>La flore des ensembles primaires et des réserves est exclusive de toutes les autres. Tant que le milieu maintient sa propre fermeture il interdit l’accès aux êtres exogènes<span class="fn">Sauf dans les cas d’un écosystème profondément perturbé où la pression des pionniers exogènes est si forte que les milieux climaciques d’origine s’en trouvent perturbés. Cas de la vigne marrone à la Réunion.</span>.</p>
    <p style="--ls:-5"><span class="enum">10 </span>La somme des délaissés constitue, par excellence, le territoire du <em>brassage planétaire</em>.</p>
    <p style="--ls:-4"><span class="enum">11 </span>La somme des milieux primaires constitue le seul territoire de résistance au brassage planétaire.</p>
    <p style="--ls:-2"><span class="enum">12 </span>La fabrique d’un délaissé, comme n’importe quel processus de secondarisation, s’accompagne d’une perte de diversité d’espèces stables. Parfois de façon irréversible.</p>
    <p style="--ls:6" class="<?= $media == "printa5" ? "break-before" : "" ?>"><span class="enum">13 </span>La résistance des milieux primaires correspond à des situations d’isolement géographique. Le nombre des espèces sur la planète est directement lié au nombre d’isolats.</p>
    ...
    <p style="--ls:-2"><span class="enum">16 </span>La forme actuelle de la planète correspond à un pic en terme d’espèces.</p>
  ...
  <section class="text " id="enjeux">
    ...
    <p style="--ls:4"><span class="enum">2 </span>La variété des comportements dépend de la latitude offerte à chaque espèce (liberté d’action) mais aussi de l’amplitude biologique de chaque espèce (capacité d’adaptation).</p>
    <p style="--ls:4"><span class="enum">3 </span>Pour les sociétés humaines la variété des comportements se joue au sein d’une seule espèce (<i>Homo sapiens</i>). Elle est tributaire de la culture dans laquelle chaque individu évolue.</p>
    ...
    <p style="--ls:4"><span class="enum">6 </span>Le cataclysme (météorites, coulées volcaniques, guerres) conduit à des diminutions massives et brutales du nombre. La transformation lente (glaciation, tropicalisation) conduit à des substitutions d’espèces, des dimi&shy;nutions ou des augmentations progressives du nombre.</p>
    <p style="--ls:-2"><span class="enum">7 </span>L’anthropisation planétaire comparée aux phénomènes naturels entraîne une diminution du nombre analogue au cataclysme.</p>
    ...
    <p class="<?= $media == "printa4" ? "break-before" : "" ?>"><span class="enum">16 </span>Pour les espèces animales et végétales, le brassage planétaire agit de façon sélective – disparition par mise en concurrence – et de façon dynamique&nbsp;: nouveaux comportements, hybridation, mutations, voire nouvelles espèces.</p>
  ...
  <section class="text" id="mobilite">
    ...
    <p  style="--ls:-5">Le Tiers paysage, siège de fortes dynamiques, change de figure dans le temps.</p>
  ...
  <section class="text <?= $media == "printa5" ? "break-before" : "" ?>" id="echelle">
  ...
  <section class="text" id="manifeste">
    <h2>Manifeste</h2>
    <p>(Chacune des phrases qui suit peut être envisagée sur le mode interrogatif)</p>
    ...
    <p style="--ls:-5">— Maintenir ou augmenter la diversité par une pratique consentie du non–aménagement.<br> — Engager un processus de requalification des substrats autorisant la vie –&nbsp;air, sol, eau&nbsp;– en modifiant les pratiques périphériques aux espaces de Tiers paysage afin de ne pas en altérer la dynamique et pour en espérer l’influence.<br> — Etablir une politique territoriale visant à ne pas diminuer les portions existantes de Tiers paysage et même à les augmenter.</p>
    ...
    <h4>Sur l’échelle</h4>
    <p><span style="--ls:-10">— Mettre à disposition les outils nécessaires à l’appréhension du Tiers paysage.</span><br> — Rendre accessibles les images satellites, les images microscopiques.<br> — Favoriser la reconnaissance à l’échelle habituelle du regard. Apprendre à nommer les êtres.</p>
    ...
    <p><span style="--ls:-9">— Effacer les échéances administratives, politiques, gestionnaires du territoire.</span><br> — Ne pas attendre&nbsp;: constater au jour le jour.<br> — Offrir au Tiers paysage la possibilité de se déployer selon un processus évolutif inconstant, par la réinterprétation quotidienne des conditions changeantes du milieu.</p>
    ...
    <p>— Inverser le regard porté sur le paysage en Occident.<br><span style="--ls:-4">— Conférer au Tiers paysage le rôle matriciel d’un paysage global en devenir.</span><br> — Déclarer le territoire du Tiers paysage lieu privilégié de l’intelligence biologique&nbsp;: aptitude à se réinventer constamment.<br> — Confronter l’hypothèse aux autres cultures planétaires, en particulier celles dont les fondements reposent sur un lien fusionnel entre l’homme et la nature.</p>
  </section>
  </div>

  <section id="gilles-clement">
    <p>
      Gilles Clément (Argenton-sur-Creuse, 1943) est un « jardinier » français ; paysagiste, botaniste, essayiste et professeur à l’école du paysage de Versailles. Il est l’auteur de concepts théoriques qui ont marqué les acteurs du paysage moderne mais aussi le grand public, tels que le « jardin en mouvement », le « jardin planétaire » et le « tiers paysage  ». En pratique, il a conçu plusieurs parcs et espaces publics français, à partir de concepts issus de l’observation de paysages naturels jamais figés, où les espèces doivent pouvoir se déplacer librement. Depuis 1977, Gilles Clément « cultive » également son propre jardin, « la vallée », sa maison, où il observe, recherche et dialogue.
    </p>
  </section>
  <footer id="colophon">
