...
<body>
  <nav id="tools">
    ...
    <ul id="menu">
      ...
      <li><a href="#">Imprimer (A5, livret)</a></li>
  ...
  <section class="text" id="mobilite">
    ...
    <p class="break-before"><span class="enum">1 </span>Par le jeu des échanges internes&nbsp;: <br>— dynamique naturelle d’accès au climax forestier</p>
    <figure id="fig-7">
      <span class="image">
  ...
  <section class="text" id="rapport-au-temps">
    ...
    <p class="break-before"><span class="enum">20 </span>La dimension temporelle offerte au processus lamarckien permet aux êtres confrontés aux transformations du milieu de chercher des solutions nouvelles de vie.</p>
  ...
  <section class="text" id="rapport-a-la-societe">
    ...
    <p class="break-before"><span class="enum">8 </span>Le délaissement du Tiers paysage par l’institution ne signifie pas délaissement absolu.</p>
